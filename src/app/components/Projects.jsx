    ...
    return (
      <>
        {projectsData.map((project) => (
          <article key={project.id} className="relative w-full h-full mb-12 sm:px-20">
            <div className="z-0"></div>
            <Image
              className="filter grayscale-[100%] sm:px-20"
              src={project.image}
              alt={project.alt}
              layout="fill"
              objectFit="fill"
      ...
      {projectsData.map((project) => (
        ...
        >
          <div className="w-96 h-80 group relative">
            ...
            <Image
              className="rounded-lg filter grayscale-[100%] group-hover:filter-none transition-all duration-300"
              src={project.image}
              alt={project.alt}
              layout="fill"
              objectFit="fill"
